...
const { postFood, getFood, deleteFood, getFoodMenu ,getDietSummaryOfTheDay,getFoodHistory, burnCalorie,getCaloriesBurnt} = require('../controllers/dietPlan.Controller/consumedCalorie.controller')
